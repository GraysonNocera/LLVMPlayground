...
entry:
  ...
  tail call void @__coverage__(i32 3, i32 8)
  ...
  tail call void @__coverage__(i32 4, i32 19)
...
do.body:                                          ; preds = %do.cond, %entry
  ...
  tail call void @__coverage__(i32 11, i32 5)
...
!1 = !DIFile(filename: "calc.c", directory: "/root/LLVMPlayground/part4_instrumentation/DivZeroInstrument/test")
!2 = !{}
