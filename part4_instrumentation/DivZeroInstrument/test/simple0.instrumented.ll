...
entry:
  ...
  tail call void @__coverage__(i32 3, i32 11)
  ...
  tail call void @__coverage__(i32 4, i32 11)
  %1 = load i32, i32* %y, align 4, !dbg !18
  tail call void @__coverage__(i32 4, i32 15)
  %2 = load i32, i32* %x, align 4, !dbg !19
  tail call void @__sanitize__(i32 %2, i32 4, i32 13)
...
!1 = !DIFile(filename: "simple0.c", directory: "/root/LLVMPlayground/part4_instrumentation/DivZeroInstrument/test")
!2 = !{}
