...
entry:
  ...
  tail call void @__coverage__(i32 4, i32 12)
  ...
  tail call void @__coverage__(i32 5, i32 15)
  ...
  tail call void @__coverage__(i32 6, i32 10)
...
if.then:                                          ; preds = %entry
  ...
  tail call void @__sanitize__(i32 %2, i32 7, i32 12)
  tail call void @__coverage__(i32 7, i32 12)
  %div = sdiv i32 %1, %2, !dbg !25
  tail call void @__coverage__(i32 7, i32 7)
  store i32 %div, i32* %d, align 4, !dbg !26
  tail call void @__coverage__(i32 8, i32 3)
  br label %if.end, !dbg !27

if.else:                                          ; preds = %entry
  tail call void @__coverage__(i32 9, i32 9)
  ...
  tail call void @__coverage__(i32 9, i32 19)
  %4 = load i32, i32* %u1, align 4, !dbg !32
  tail call void @__coverage__(i32 9, i32 22)
  %add = add nsw i32 %4, 1, !dbg !33
  tail call void @__sanitize__(i32 %add, i32 9, i32 16)
  tail call void @__coverage__(i32 9, i32 16)
...
if.end:                                           ; preds = %if.else, %if.then
  tail call void @__coverage__(i32 11, i32 3)
  ret i32 0, !dbg !35
}
...
!1 = !DIFile(filename: "simple6.c", directory: "/root/LLVMPlayground/part4_instrumentation/DivZeroInstrument/test")
!2 = !{}
